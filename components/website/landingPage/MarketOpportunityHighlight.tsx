  ...
  return (
    <div
      className="
        ...
        hover:-translate-y-1 hover:shadow-2xl hover:ring-blue-400/30
  ...
  return (
    <section className="w-full market">
      ...
      >
        ...
        <div
          className="
            mt-10 grid grid-cols-1 gap-8 rounded-2xl bg-blue p-6 shadow-lg sm:grid-cols-2
            ...
            heading={
              <span className="inline-flex items-center gap-2">
                ...
                <span className="inline-flex items-center">
                  {/* animated arrow */}
                  <ArrowRight className="h-6 w-6 text-blue motion-safe:animate-[arrow_.9s_ease-in-out_infinite]" />
                </span>
        ...
        <div className="mt-8">
          <a
            ...
            className="
              ...
              bg-blue-100 px-6 py-3 text-sm font-semibold text-blue-900 shadow-lg
              transition focus:outline-none focus:ring-2 focus:ring-white/60
              hover:bg-blue-200 hover:shadow-emerald-400/30
            "
          >
